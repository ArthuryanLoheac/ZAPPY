...
class GraphicalException : public std::exception {
 public:
     ...
     * @brief Constructor
        ...
        */
    explicit GraphicalException(const std::string &message) :
        _message(message) {}
...
class TextureLoadingException : public GraphicalException {
 public:
    explicit TextureLoadingException(const std::string &filename)
...
class ShaderCompilationException : public GraphicalException {
 public:
    explicit ShaderCompilationException(const std::string &message)
...
class FontLoadingException : public GraphicalException {
 public:
    explicit FontLoadingException(const std::string &filename)

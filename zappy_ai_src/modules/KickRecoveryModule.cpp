...
float KickRecoveryModule::getPriority() {
    bool hasUnprocessedKicks = AI::Data::i().kickVector.size() > static_cast<size_t>(processedKicks);
 ...
 */
std::vector<std::string> KickRecoveryModule::getRecoveryCommands(int direction) {
